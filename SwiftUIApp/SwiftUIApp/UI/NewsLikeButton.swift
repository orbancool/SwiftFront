...
class NewsLikeButton: UIButton {
    ...
    func defaultState() {
        ...
        tintColor = .gray
        imageEdgeInsets = UIEdgeInsets(top: 30, left: 0, bottom: 0, right: 30)
        titleEdgeInsets = UIEdgeInsets(top: 30, left: -10, bottom: 0, right: -10)
